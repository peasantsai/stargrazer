/** Platform icons and brand colours. Centralised here so every component
 *  references the same values (DRY). */

export const PLATFORM_IDS = ['facebook', 'instagram', 'tiktok', 'youtube', 'linkedin', 'x'] as const;
...
export const PLATFORM_COLORS: Record<string, PlatformColors> = {
